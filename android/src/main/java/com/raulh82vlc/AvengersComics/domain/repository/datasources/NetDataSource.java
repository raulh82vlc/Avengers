...
package com.raulh82vlc.AvengersComics.domain.repository.datasources;
...
public interface NetDataSource<C> {
     ...
     * @param heroID Super hero ID
     * @param pageID number of page for retrieving a pre-established amount of comics
     */
    C getComicsList(String heroID, int pageID) throws ConnectionException, HttpException;
}
