 ...
 */
public class GetMoreComicsListCallbackImplTest {
    ...
    public void setup() throws Exception {
        initMocks(this);
        callbackToTest = spy(new GetMoreComicsListCallbackImpl(view, mapper));
    }
    ...
    public void callbackIsWorkingForOKAndReady() throws Exception {
        ...
        verify(view, getTimes()).addMoreComicsToList(anyList());
    ...
    @Test
    public void callbackIsWorkingForKOAndNotReady() throws Exception {
        // when it is returned true for the isReady method by default,
        // then we could check 1 iteration appears on each method
    ...
    @Test
    public void callbackIsWorkingForOKAndNotReady() throws Exception {
        // when it is returned true for the isReady method by default,
        // then we could check 1 iteration appears on each method
        when(view.isReady()).thenReturn(false);
        comics.add(mock(ComicUI.class));
        ...
        verify(view, getNoTime()).addMoreComicsToList(anyList());
