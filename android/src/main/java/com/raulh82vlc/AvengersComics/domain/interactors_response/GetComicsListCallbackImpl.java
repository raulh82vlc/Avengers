...
/**
 * Get Comics list by means of its callback extends its base class {@link GetComicsListBaseCallbackImpl}
 *
 * @author Raul Hernandez Lopez.
 */
public class GetComicsListCallbackImpl extends GetComicsListBaseCallbackImpl {

    @Override
    void addComics(ComicsPresenter.View view, List<ComicUI> comics) {
        view.updateComicsList(comics);
    }

    public GetComicsListCallbackImpl(ComicsPresenter.View view,
